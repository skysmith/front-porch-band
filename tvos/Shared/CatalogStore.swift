...
final class CatalogStore: ObservableObject {
    ...
    init(bundle: Bundle = .main) {
        do {
            ...
            self.chordLibrary = (try? CatalogStore.load(ChordLibraryData.self, named: "ChordLibrary", bundle: bundle)) ?? .empty
    ...
    var allSongsSorted: [SongRecord] {
        catalog.songs.sorted { lhs, rhs in
